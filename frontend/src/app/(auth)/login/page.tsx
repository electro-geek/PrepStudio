    ...
    <div className="relative min-h-screen text-foreground flex items-center justify-center px-4 py-16">
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="font-display font-extrabold tracking-tight text-2xl mt-6">Welcome back</h2>
          <p className="section-label mt-2">Operator sign-in</p>
        </div>
          ...
          <div className="p-7">
            {isMock && (
              <div className="card bg-panel/60 px-3.5 py-3 mb-5 flex items-start gap-2.5 text-xs">
                ...
                <span className="text-muted"><strong className="font-semibold text-foreground">Dev mode:</strong> Any email and password works via mock authentication.</span>
              </div>
            )}
            {error && (
        ...
        <p className="text-center text-sm text-muted mt-4">
          No account?{" "}
          <Link href="/signup" className="text-primary hover:text-primary-hover font-semibold">Sign up →</Link>
        </p>
      </div>
    </div>
  );
